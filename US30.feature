Feature: Acceso a Videos Educativos
  ...
  Scenario: ES01: Visualizar la biblioteca de videos educativos
    ...
    Examples:
      | categoría          | título del video                     |
      | "Nutrición"        | "Alimentación saludable para niños"  |
      | "Ejercicio"        | "Rutinas de ejercicio en casa"       |
      | "Prevención"       | "Cómo prevenir enfermedades comunes" |
